...
const en = {
    ...
    settingsScreenDisplayTitle: 'Display',
    settingsScreenOrientationLabel: 'Screen Orientation',
    settingsScreenOrientationAuto: 'Allow rotation',
    settingsScreenOrientationPortrait: 'Portrait only',
    settingsScreenOrientationSmart: 'Smart (auto for iPads)',
