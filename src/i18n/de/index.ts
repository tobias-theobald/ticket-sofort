...
const de = {
    ...
    settingsScreenDisplayTitle: 'Anzeige',
    settingsScreenOrientationLabel: 'Bildschirmausrichtung',
    settingsScreenOrientationAuto: 'Rotation erlauben',
    settingsScreenOrientationPortrait: 'Nur Hochformat',
    settingsScreenOrientationSmart: 'Smart (Auto für iPads)',
